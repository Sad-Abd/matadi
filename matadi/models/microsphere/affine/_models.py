...
from ....math import sum1, diag, sqrt, inv, det, reshape, dev, cof
from ..quadrature._bazant_oh import BazantOh


@isochoric_volumetric_split
def microsphere_affine_stretch(C, f, kwargs, quadrature=BazantOh(n=21)):
...
@isochoric_volumetric_split
def microsphere_affine_tube(C, f, kwargs, quadrature=BazantOh(n=21)):
